...
module.exports = {
    async handler(chatUpdate) {
        ...
        global.namabot = 'Kimimaru'
        global.wm = namabot + ' Multi-Device Bot'
                    ...
                    for (let user of participants) {
                        ...
                        try {
                           ...
                           /* let wel = API('males', '/welcome2', {
                            ...
                            await this.sendButtonDoc(id, text, wm, action === 'add' ? 'selamat datang' : 'sampai jumpa', action === 'add' ? '.intro' : 'Kimimaru', fkontak, { contextInfo: global.adReply.contextInfo })
                        }
                    }
                }
                break
